                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Create Content</p>

                                <form action="handelCreateContent.php" method="POST" enctype="multipart/form-data">
                                     <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                                        <div class="form-outline flex-fill mb-0">
                                            <label class="form-label" for="form3Example3c">Title</label>

                                            <input type="text" name="title" id="form3Example3c" class="form-control" />
                                        </div>
                                    </div>
