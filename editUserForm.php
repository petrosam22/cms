                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form method="POST" action="updateUser.php?id=<?php echo $user['id']; ?>" enctype="multipart/form-data">
                                     <div class="d-flex flex-row align-items-center mb-4">
                                        <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                                        <div class="form-outline flex-fill mb-0">
                                            <label class="form-label" for="form3Example3c">Title</label>

                                            <input type="text" name="name" value="<?php echo $user['name']; ?>"  id="form3Example3c" class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            ...
                                            <input type="text" name="email" value="<?php echo $user['email']; ?>"  id="form3Example3c" class="form-control" />
